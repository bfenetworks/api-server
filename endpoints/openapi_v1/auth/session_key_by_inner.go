...
var _ xreq.Handler = SessionKeyByInnerAction

// SessionKeyByInnerAction action
// AUTO GEN BY ctrl, MODIFY AS U NEED
func SessionKeyByInnerAction(req *http.Request) (interface{}, error) {
	user, err := container.AuthenticateManager.CreateInnerUser(req.Context())
	if err != nil {
		return nil, err
	}

	return &UserIdentifyData{
